...
PYBIND11_MODULE(pyqreach, m) {
    ...
    py::class_<Location>(m, "Location")
        ...
        .def("satisfyDefault", &Location::satisfyDefault, "satisfy without argument, check if lowerBound <= upperBound")
        .def("setIdentifier", &Location::setIdentifier, "setIdentifier")
        .def("getIdentifier", &Location::getIdentifier, "getIdentifier")
